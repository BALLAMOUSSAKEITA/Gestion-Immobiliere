  ...
  return (
    <main className="flex flex-col gap-6 px-6 py-10">
      <div>
        ...
        <p className="mt-2 text-zinc-600">Détails de votre logement actuel.</p>
      </div>
      ...
      {unit && (
        <div className="space-y-4 rounded-xl border border-zinc-200 bg-white p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <p className="text-sm text-zinc-500">Commune</p>
              <p>
                {unit.commune}
          ...
          {unit.description && (
            <p className="rounded-lg bg-zinc-50 p-4 text-zinc-700">{unit.description}</p>
          )}
